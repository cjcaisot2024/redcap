...
if (!class_exists('WP_Bootstrap_Navwalker')) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
		{
			...
			if (isset($args->has_children) && $args->has_children && 0 === $depth && $args->depth > 1) {
				...
				if ($depth > 0) {
					...
					$atts['class'] = 'nav-link header-text font-sm-18';
					$atts['data-parent-item'] = sanitize_title($item->title);
				}
			}
		...
		// metodo para sanitizar texto, titulos. remover espacios y signos.
		public function sanitize_title($title) {
			...
			// Reemplazar todos los caracteres que no sean letras, números o guiones por un guion
